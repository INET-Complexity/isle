...
simulation_parameters={"no_categories": 4,
                       ...
                       "margin_increase": 0.6, # This parameter modifies the margin of safety depending on the number of risks models available in the market. When is 0 all risk models have the same margin of safety.
